...
describe('Job Flow Methods', () => {
  ...
  describe('parentId property', () => {
    it('should have parentId set for child jobs', async () => {
      const queue = new Queue({ redis, namespace: `${namespace}-parentid`, keepCompleted: 10 });
    ...
    it('should have undefined parentId for non-child jobs', async () => {
      const queue = new Queue({ redis, namespace: `${namespace}-no-parent`, keepCompleted: 10 });
    ...
    it('should have undefined parentId for parent jobs', async () => {
      const queue = new Queue({ redis, namespace: `${namespace}-parent-no-parentid`, keepCompleted: 10 });
      ...
      await queue.addFlow({
        parent: { jobId: parentId, groupId: 'g-parent', data: { name: 'parent' } },
        children: [
          { groupId: 'g-child', data: { name: 'child' } },
        ],
      });
  ...
  describe('getChildren()', () => {
    it('should return all child jobs for a parent', async () => {
      const queue = new Queue({ redis, namespace: `${namespace}-getchildren`, keepCompleted: 10 });
    ...
    it('should return empty array for jobs with no children', async () => {
      const queue = new Queue({ redis, namespace: `${namespace}-getchildren-empty`, keepCompleted: 10 });
    ...
    it('should skip deleted child jobs gracefully', async () => {
      const queue = new Queue({ redis, namespace: `${namespace}-getchildren-deleted`, keepCompleted: 10 });
      ...
      await redis.del(`groupmq:${namespace}-getchildren-deleted:job:${child1Id}`);
  ...
  describe('getChildrenValues()', () => {
    it('should return child job results', async () => {
      const queue = new Queue({ redis, namespace: `${namespace}-getchildrenvalues`, keepCompleted: 10 });
      ...
      expect(values['child-v-1']).toEqual({ computed: 20 });
      expect(values['child-v-2']).toEqual({ computed: 40 });
    });

    it('should return empty object for jobs with no children', async () => {
      const queue = new Queue({ redis, namespace: `${namespace}-getchildrenvalues-empty`, keepCompleted: 10 });
  ...
  describe('getDependenciesCount()', () => {
    it('should return correct count of remaining children', async () => {
      const queue = new Queue({ redis, namespace: `${namespace}-getdepscount`, keepCompleted: 10 });
      ...
      await queue.addFlow({
        parent: { jobId: parentId, groupId: 'g-parent', data: { name: 'parent' } },
        children: [
          { jobId: 'child-d-1', groupId: 'g-child-1', data: { name: 'child1' } },
          { jobId: 'child-d-2', groupId: 'g-child-2', data: { name: 'child2' } },
          { jobId: 'child-d-3', groupId: 'g-child-3', data: { name: 'child3' } },
        ],
      });
    ...
    it('should return null for non-parent jobs', async () => {
      const queue = new Queue({ redis, namespace: `${namespace}-getdepscount-null`, keepCompleted: 10 });
  ...
  describe('getParent()', () => {
    it('should return parent job for child jobs', async () => {
      const queue = new Queue({ redis, namespace: `${namespace}-getparent`, keepCompleted: 10 });
    ...
    it('should return undefined for jobs with no parent', async () => {
      const queue = new Queue({ redis, namespace: `${namespace}-getparent-undefined`, keepCompleted: 10 });
    ...
    it('should return undefined when parent is deleted', async () => {
      const queue = new Queue({ redis, namespace: `${namespace}-getparent-deleted`, keepCompleted: 10 });
  ...
  describe('Queue.getFlowChildrenIds()', () => {
    it('should return all child IDs for a parent', async () => {
      const queue = new Queue({ redis, namespace: `${namespace}-flowchildrenids`, keepCompleted: 10 });
    ...
    it('should return empty array for non-parent jobs', async () => {
      const queue = new Queue({ redis, namespace: `${namespace}-flowchildrenids-empty`, keepCompleted: 10 });
  ...
  describe('Flow cleanup on remove', () => {
    it('should clean up children set when parent is removed', async () => {
      const queue = new Queue({ redis, namespace: `${namespace}-cleanup-parent`, keepCompleted: 10 });
      ...
      await queue.addFlow({
        parent: { jobId: parentId, groupId: 'g-parent', data: { name: 'parent' } },
        children: [
          { jobId: 'child-cleanup-1', groupId: 'g-child', data: { name: 'child' } },
        ],
      });
    ...
    it('should remove child from parent children set when child is removed', async () => {
      const queue = new Queue({ redis, namespace: `${namespace}-cleanup-child`, keepCompleted: 10 });
